                        ...
                        <Tooltip>
                          ...
                          <TooltipContent className="w-96">
                            <p>
                              ...
                              book, take the summary from the back of the book.
                              If you are writing about a movie, take the summary
                              from IMDB. If you are writing about a product,
                              take the description from the product page. The
                              more content you give the model, the better the
