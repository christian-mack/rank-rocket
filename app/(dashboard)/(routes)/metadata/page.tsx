    ...
    <TooltipProvider>
      <section className="flex w-full h-full flex-col">
        <div className="w-full">
          <h1>
            Generate hyper-relevant metadata suggestions. Just add your content.
          </h1>
        </div>
        <div>
                      ...
                      render={({ field }) => (
                        <FormItem className="w-full sm:w-52">
                          <Tooltip>
                            ...
                            <TooltipContent className="w-96">
                              <p>
                                This will help the model generate more relevant
                                suggestions as well but not as important as the
                                primary keyword.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        ...
                        <FormItem className="w-full sm:w-52">
                          <Tooltip>
                            ...
                            <TooltipContent className="w-96">
                              <p>
                                This will help the model generate more relevant
                                suggestions but will not be as important as the
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent className="w-96">
                              <p>
                                ...
                                content directly from the source you are writing
                                about. For example, if you are writing about a
                                book, take the summary from the back of the
                                book. If you are writing about a movie, take the
                                summary from IMDB. If you are writing about a
                                product, take the description from the product
                                page. The more content you give the model, the
                                better the final output will be.
                              </p>
                            </TooltipContent>
                          </Tooltip>
                          <FormControl>
                            <Textarea
                              className="focus-visible:ring-0 focus-visible:ring-transparent h-64"
                              disabled={isLoading}
              ...
              {formattedMessages.map(
                (message, index) =>
                  message.role !== "user" && (
                    <div
                      key={index}
                      className="w-full h-full flex items-start rounded-lg bg-muted">
                      <Alert>
